            ...
            var e = "carousel",
                ...
                p = function() {
                    ...
                    return p.next = function() {
                        ...
                        if (e === c.NEXT ? (i = f.LEFT, o = f.NEXT, s = c.LEFT) : (i = f.RIGHT, o = f.PREV, s = c.RIGHT), h && t(h).hasClass(f.ACTIVE)) this._isSliding = !1;
                        ...
                        if (i) {
                            ...
                            if (o && t(o).hasClass(f.CAROUSEL)) {
                                var a = t.extend({}, t(o).data(), t(this).data()),
            ...
            var e = t.fn.tab,
                ...
                a = function() {
                    ...
                    return a.show = function() {
                        ...
                        var a, l = this,
                            c = (a = "UL" === n.nodeName ? t(n).find(s.ACTIVE_UL) : t(n).children(s.ACTIVE))[0],
